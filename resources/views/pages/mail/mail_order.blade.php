...
<head>
    ...
    <title>New email template 2022-01-01</title>
    <!--[if (mso 16)]>
    <style type="text/css">
        a {
                    ...
                    <tr style="border-collapse:collapse">
                        <td align="center" style="padding:0;Margin:0">
                            <table class="es-header-body"
                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#1a94ff;width:800px"
                                   cellspacing="0" cellpadding="0" bgcolor="#6fa8dc" align="center">
                                <tr style="border-collapse:collapse">
                                    <td align="left" bgcolor="#2a9af4"
                                        style="Margin:0;padding-top:5px;padding-bottom:5px;padding-left:15px;padding-right:15px;background-color:#1a94ff">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td class="es-m-p0l es-m-txt-c" align="center"
                                                                ...
                                                                <h1 style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;font-size:30px;color: #ffffff;">HABECOM</h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                ...
                                                                <h1 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:'trebuchet ms', helvetica, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#333333">
                                                                    Hoá Đơn<br></h1>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                ...
                                <tr style="border-collapse:collapse">
                                    <td align="left"
                                        ...
                                        <table style="width:760px" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="width:380px" valign="top"><![endif]-->
                                        <table class="es-left" cellspacing="0" cellpadding="0" align="left"
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td class="es-m-p20b" align="left"
                                                    ...
                                                    <table
                                                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#a3d1f6;border-color:#efefef;border-width:1px 0px 1px 1px;border-style:solid"
                                                        width="100%" cellspacing="0" cellpadding="0" bgcolor="#a3d1f6"
                                                        role="presentation">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                        ...
                                        <table class="es-right" cellspacing="0" cellpadding="0" align="right"
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td align="left" style="padding:0;Margin:0;width:380px">
                                                    <table
                                                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#a3d1f6;border-width:1px;border-style:solid;border-color:#efefef"
                                                        width="100%" cellspacing="0" cellpadding="0" bgcolor="#a3d1f6"
                                                        role="presentation">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <table
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0"><span
                                                                                style="font-size:13px">TÊN SẢN PHẨM</span>
                                                                        </td>
                                ...
                                @foreach($cart as $item)
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td align="left"
                                                                ...
                                                                <td align="center" style="padding:0;Margin:0;font-size:0">
                                                                    <a href="https://viewstripo.email" target="_blank"
                                                                       style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#D48344;font-size:14px"><img
                                                                            src="https://tapdoandaiviet.com.vn/multidata/taw-42810h.png"
                                            ...
                                            <td style="width:462px" valign="top"><![endif]-->
                                            <table cellspacing="0" cellpadding="0" align="right"
                                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr style="border-collapse:collapse">
                                                    <td align="left" style="padding:0;Margin:0;width:462px">
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                               role="presentation"
                                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        cellpadding="1" border="0" role="presentation">
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0">{{$item->product_name}}
                                                                            </td>
                                ...
                                <tr style="border-collapse:collapse">
                                    <td align="left"
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                            <tr style="border-collapse:collapse">
                                                <td valign="top" align="center" style="padding:0;Margin:0;width:740px">
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                           role="presentation"
                                                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="right" style="padding:0;Margin:0">
                                                                <table
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;text-align:right;font-size:18px;line-height:27px">
                                                                            <strong>Số Tiền Thanh Toán:</strong></td>
                                                                        <td style="padding:0;Margin:0;text-align:right;font-size:18px;line-height:27px;color:#d48344">
                                                                            <strong> @money($order->grand_total)</strong></td>
                                                                    </tr>
                                                                </table>
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    <br></p>
                    ...
                    <tr style="border-collapse:collapse">
                        <td align="center" style="padding:0;Margin:0">
                            <table class="es-footer-body" cellspacing="0" cellpadding="0" align="center"
                                ...
                                <tr style="border-collapse:collapse">
                                    <td align="center" bgcolor="#a3d1f6"
                                        style="padding:20px;Margin:0;background-color:transparent">
                                        <!--[if mso]>
                                        <table style="width:760px" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="width:278px" valign="top"><![endif]-->
