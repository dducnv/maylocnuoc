    ...
    <div class="py-4">
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">{{__('Sửa sản phẩm')}} {{$product->product_name}} </h1>
            </div>
            <div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            <input id="thumbnail"
                                   ...
                                   value="{{old("thumbnail")}}"
                                   name="thumbnail">
                            <input hidden value="{{$product->product_image}}" readonly="readonly" id="thumbnail"
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input hidden value="{{$product->product_gallery}}" readonly="readonly"
                                   id="thumbnail-gallery"
                                   class="form-control @error('product-gallery') is-invalid @enderror" type="text"
                                   name="product-gallery-old">
                        </div>
                        ...
                        @php
                            $product_gallery = json_decode($product->product_gallery,true);
                        @endphp
                        ...
                        <div class="col-lg-12 col-sm-12 mt-4 mt-md-0">
                            ...
                            <div class="form-check form-switch">
                                <input @if($product->product_status == 0) checked @endif name="product-status"
                        ...
                        <div class="row mb-">
                            <div class="col-lg-12 col-sm-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input value="{{$product->product_name}}" name="product-name" type="text"
                                           onkeyup="productSlug()"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input value="{{$product->product_slug}}" name="product_slug" type="text"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input value="{{$product->product_tags}}" name="product-keywords" type="text"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input value="{{$product->product_price}}" name="product-price" type="number"
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="product-brand" id="product-brand"
                                        ...
                                        @foreach($brand as $item)
                                            <option @if ($product->brand_id == $item ->id) selected
                                                    @endif value="{{$item->id}}">{{$item->brand_name}}</option>
                                        @endforeach
                                    </select>
                                    @error('product-brand')
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-lg-12 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="product-desc"
                                              class="form-control @error('product-desc') is-invalid @enderror">{{$product->product_desc}}</textarea>
                                    @error('product-desc')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="product-content" id="content"
                                              class="form-control @error('product-content') is-invalid @enderror">{{$product->product_content}}</textarea>
