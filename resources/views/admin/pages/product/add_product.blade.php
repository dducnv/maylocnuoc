            ...
            <div class="card border-0 shadow components-section">
                <div class="card-body">
                    ...
                    <div class="input-group mb-3">
                        <a  data-input="thumbnail" data-preview="thumbnail-preview" class="input-group-text" id="thumbnail-img">
                            {{__('Chọn')}}
                        </a>
                        <input readonly="readonly" id="thumbnail" class="form-control @error('thumbnail') is-invalid @enderror" type="text" name="thumbnail"  >
                    </div>
                    @error('thumbnail')
                    ...
                    <div class="input-group mb-3">
                        <a  data-input="thumbnail-gallery" data-preview="gallery-preview" class="input-group-text" id="gallery-img">
                            {{__('Chọn')}}
                        </a>
                        <input readonly="readonly" id="thumbnail-gallery" class="form-control @error('product-gallery') is-invalid @enderror" type="text" name="product-gallery"  >
                    </div>
                    ...
                    <div id="gallery-preview" class="img-preview mb-3" >
                        ...
                        <div class="col-lg-12 col-sm-12 mt-4 mt-md-0">
                            ...
                            <div class="form-check form-switch">
                                <input name="product-status" class="form-check-input" type="checkbox" id="flexSwitchCheckDefault">
                            ...
                            <div class="row mb-">
                                <div class="col-lg-12 col-sm-12">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input name="product-name" type="text" onkeyup="productSlug()" class="form-control @error('product-name') is-invalid @enderror" id="product-name">
                                        @error('product-name')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input name="product_slug" type="text" class="form-control @error('product_slug') is-invalid @enderror" id="product-slug">
                                        @error('product_slug')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input name="product-keywords" type="text" class="form-control @error('product-keywords') is-invalid @enderror" id="product-slug" data-role="tagsinput" aria-describedby="keywords">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input name="product-price" type="text" class="form-control @error('product-price') is-invalid @enderror" id="product-price">
                                        @error('product-price')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                   ...
                   <div class="row mb-">
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="product-desc" id="desc" class="form-control @error('product-desc') is-invalid @enderror">
