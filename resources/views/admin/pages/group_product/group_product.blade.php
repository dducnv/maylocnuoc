    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{__('Nhãn Hiệu')}}</li>
            </ol>
        </nav>
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow mb-4">
            <div class="card-body">
                <form>
                    <div class="mb-3">
                        <label for="firstName">{{__('Tên Nhóm')}}</label>
                    ...
                    <div class="mb-3">
                        <label for="firstName">{{__('slug')}}</label>
                        <input type="text" class="form-control " id="firstName"  required>
                        {{-- <div class="valid-feedback">
                            Looks good!
                        </div>                 --}}
                    ...
                    <div class="mb-3">
                        <label for="firstName">{{__('Từ Khóa')}}</label>
                        <input type="text" class="form-control" id="firstName"  required>
                        {{-- <div class="valid-feedback">
                            Looks good!
                        </div>                 --}}
                    ...
                    <table class="table table-centered table-nowrap mb-0 rounded">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{__('Tên Nhóm')}}</th>
