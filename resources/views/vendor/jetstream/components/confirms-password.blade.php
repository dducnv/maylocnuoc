@props(['title' => __('Xác nhận mật khẩu'), 'content' => __('Để bảo mật cho bạn, vui lòng xác nhận mật khẩu của bạn để tiếp tục.'), 'button' => __('Xác nhận')])
...
<x-jet-dialog-modal wire:model="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <x-jet-input type="password" class="mt-1 block w-3/4" placeholder="{{ __('Nhập mật khẩu') }}"
